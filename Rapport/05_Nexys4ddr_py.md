...
Ce fichier sert de base à la description de la plateforme. Nous nous sommes appuyé sur la version disponible de Litex car déjà très complet.

Voici le fichier de Litex d'origine:

https://github.com/enjoy-digital/litex/blob/master/litex/boards/platforms/nexys4ddr.py

Dans la suite de ce Wiki nous expliquerons les ajouts que nous avons effectué dans ce fichier pour implémenter les autres composants/périphériques.
